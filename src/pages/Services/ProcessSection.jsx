      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto mt-3">
            From consultation to delivery, our process is designed to keep things simple, transparent, and effective.
          </p>
        </div>
        ...
        <div className="relative border-l-4 border-yellow-400 ml-4 sm:ml-10">
          {steps.map((item, index) => (
            <div key={index} className="mb-12 ml-6 sm:ml-10 relative  ">
              {/* Circle marker */}
              <div className="absolute -left-8 sm:-left-12 top-1 w-6 h-6 bg-yellow-500 rounded-full border-4 border-white shadow-md"></div>

              {/* Step Content */}
              <div className="bg-gray-50 border border-gray-200 rounded-xl shadow-md p-6 transition duration-700 hover:scale-[1.03] hover:shadow-lg">
                <p className="text-xs font-bold text-yellow-500 uppercase tracking-widest">
                  {item.step}
                </p>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-1">
                  {item.title}
                </h3>
